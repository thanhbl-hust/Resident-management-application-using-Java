    ...
    public void initialize(URL arg0, ResourceBundle arg1) {
        ...
        try {
            ...
            for (int i = 0; i < 12; i++) {
                ...
                query = "SELECT COUNT(*) FROM dbo.TamTru WHERE (MONTH(TuNgay) + YEAR(TuNgay)*100) <= (" + month +" + " + year + "*100) AND  (MONTH(DenNgay) + YEAR(DenNgay)*100) >= (" + month +" + " + year + "*100)";
